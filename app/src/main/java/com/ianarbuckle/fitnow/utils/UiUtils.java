...
public class UiUtils {
  ...
  public static void customiseToolbar(View view) {
    ...
    for(int i = 0; i < toolbar.getChildCount(); i++) {
      ...
      if(childView instanceof TextView) {
        ...
        tvToolbar.setTextColor(ContextCompat.getColor(childView.getContext(), R.color.colorWhite));
      }
    }
  }
  ...
  public static Drawable colourAndStyleActionBar(View view) {
    ...
    backArrow.setColorFilter(ContextCompat.getColor(view.getContext(), R.color.colorWhite), PorterDuff.Mode.SRC_ATOP);
    return backArrow;
  }
