...
public class BikeLeadersSpeedAdapter extends FirebaseRecyclerAdapter<BikeModel, BikeLeadersViewHolder> {

  Context context;

  public BikeLeadersSpeedAdapter(Class<BikeModel> modelClass, int modelLayout, Class<BikeLeadersViewHolder> viewHolderClass, Query ref, Context context) {
