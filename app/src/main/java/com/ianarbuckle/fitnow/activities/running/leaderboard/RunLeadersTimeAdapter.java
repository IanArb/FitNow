...
public class RunLeadersTimeAdapter extends FirebaseRecyclerAdapter<RunWalkModel, RunLeadersViewHolder> {

  Context context;

  public RunLeadersTimeAdapter(Class<RunWalkModel> modelClass, int modelLayout, Class<RunLeadersViewHolder> viewHolderClass, Query ref, Context context) {
