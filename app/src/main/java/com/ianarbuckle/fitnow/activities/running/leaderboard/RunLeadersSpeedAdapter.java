...
public class RunLeadersSpeedAdapter extends FirebaseRecyclerAdapter<RunWalkModel, RunLeadersViewHolder> {

  Context context;

  public RunLeadersSpeedAdapter(Class<RunWalkModel> modelClass, int modelLayout, Class<RunLeadersViewHolder> viewHolderClass, Query ref, Context context) {
