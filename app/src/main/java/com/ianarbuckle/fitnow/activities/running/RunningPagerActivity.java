package com.ianarbuckle.fitnow.activities.running;
...
import com.ianarbuckle.fitnow.activities.running.myactivity.RunMyActivityFragment;
import com.ianarbuckle.fitnow.home.HomeActivity;
import com.ianarbuckle.fitnow.activities.running.leaderboard.RunLeadersFragment;
...
public class RunningPagerActivity extends BaseActivity {
  ...
  private class StartRunningAdapter extends FragmentStatePagerAdapter {
    ...
    public Fragment getItem(int position) {
      switch (position) {
        case 0:
          return RunMyActivityFragment.newInstance();
        case 1:
