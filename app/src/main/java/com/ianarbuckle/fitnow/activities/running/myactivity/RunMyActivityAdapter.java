...
public class RunMyActivityAdapter extends FirebaseRecyclerAdapter<RunWalkModel, RunMyActivityCardView> {
  ...
  @Override
  protected void populateViewHolder(RunMyActivityCardView viewHolder, final RunWalkModel model, int position) {
    ...
    getBtnShareListener(model, btnShare);


  }

  private void getLearnMoreBtnListener(final RunWalkModel model, Button btnLearnMore) {
  ...
  private void getBtnShareListener(final RunWalkModel model, Button btnShare) {
