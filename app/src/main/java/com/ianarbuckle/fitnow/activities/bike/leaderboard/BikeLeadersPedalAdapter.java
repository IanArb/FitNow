...
public class BikeLeadersPedalAdapter extends FirebaseRecyclerAdapter<BikeModel, BikeLeadersViewHolder> {

  Context context;

  public BikeLeadersPedalAdapter(Class<BikeModel> modelClass, int modelLayout, Class<BikeLeadersViewHolder> viewHolderClass, Query ref, Context context) {
  ...
  private ImageView getViews(BikeLeadersViewHolder viewHolder, BikeModel model, int position) {
    ...
    String formatSpeed = StringUtils.formatSpeed(model.getPedalSpeed());
