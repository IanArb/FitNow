package com.ianarbuckle.fitnow.activities.walking;
...
import com.ianarbuckle.fitnow.activities.walking.myactivity.WalkMyActivityFragment;
import com.ianarbuckle.fitnow.home.HomeActivity;
import com.ianarbuckle.fitnow.activities.walking.leaderboard.WalkLeadersFragment;
...
public class WalkPagerActivity extends BaseActivity {
  ...
  private class StartWalkAdapter extends FragmentStatePagerAdapter {
    ...
    public Fragment getItem(int position) {
      switch (position) {
        case 0 :
          return WalkMyActivityFragment.newInstance();
        case 1:
