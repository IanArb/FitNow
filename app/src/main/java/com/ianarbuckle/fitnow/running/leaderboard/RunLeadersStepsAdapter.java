...
public class RunLeadersStepsAdapter extends FirebaseRecyclerAdapter<RunWalkModel, RunLeadersViewHolder> {

  Context context;

  public RunLeadersStepsAdapter(Class<RunWalkModel> modelClass, int modelLayout, Class<RunLeadersViewHolder> viewHolderClass, Query ref, Context context) {
